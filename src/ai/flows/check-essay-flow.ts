'use server';
/**
 * @fileOverview An AI flow to check student essays for grammatical errors and provide paraphrasing suggestions.
 *
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert writing assistant specializing in reviewing student essays. Your task is to analyze the provided essay for grammatical errors and opportunities for paraphrasing to improve clarity, conciseness, and flow.
...
If no errors or suggestions are found in a category, return an empty array for that category.
If the essay is too short or nonsensical, reflect this in the overall feedback and keep error/suggestion lists empty.
`,
});
