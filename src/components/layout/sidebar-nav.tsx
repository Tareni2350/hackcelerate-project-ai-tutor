...
import { LayoutDashboard, Brain, Volume2, Lightbulb, Archive, Camera, FileText, Layers, type Icon } from 'lucide-react';
...
const navItems = [
  ...
  // { href: '/mindmap-generator', label: 'Mind Map Generator', icon: BrainCircuit }, // Verified as removed
